...
if __name__ == '__main__':
    ...
    for fold in [10]:
        ...
        for n_trees in [500]:
            ...
            save_path_downwards = "/mnt/localdata1/amatskev/esc_project_rf/fold_eval/downwards_results_trees_{}_k_{}.pkl".format(n_trees,fold)
            save_path_upwards = "/mnt/localdata1/amatskev/esc_project_rf/fold_eval/upwards_results_trees_{}_k_{}.pkl".format(n_trees,fold)
